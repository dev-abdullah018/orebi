  ...
  return (
    <Container>
       ...
       <div className='mt-32 mb-28'>
        <h4 className='font-dm font-normal text-[39px] text-primary leading-[52px]'>Orebi is one of the world’s leading ecommerce brands and is internationally recognized for celebrating the essence of classic Worldwide cool looking style.</h4>
       </div>
